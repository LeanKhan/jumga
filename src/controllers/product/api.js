...
module.exports = {
  async authorizeShopAdmin(req, res, next) {
    if (!req.user.shop || !req.user.hasShop) {
      ...
      return res.status(401).send({ success: false, msg: 'UNAUTHORISEEEED!' });
    }
    ...
    try {
      ...
      if (shop_country.short_code != cust_country.short_code) {
        ...
        if (shop_country.short_code == 'UK') {
          ...
          // IDK, I didn't see any international processing fees for the UK...
        }
      ...
      const data = {
        ...
        meta: {
          ...
          shop_money: price / exchange_rate - product_commision / exchange_rate,
